...
This is a fork of StackEdit, tweaked for usage within an Electron application.

Current revision from StackEdit repo: 82ba08f

You can find the original README content below.
